...
public class CategoriaDAOImp implements ICategoriaDAO {
	...
	public CategoriaDTO obtenerCategoriaSuperiorA(String nombreCategoria) throws DAOExcepcion{
		try{
			connManager.connect();
			ResultSet rs=connManager.queryDB("select * from CATEGORIA where CATEGORIASUPERIOR='"+nombreCategoria+"'");						
			connManager.close();
	...
	public CategoriaDTO buscarCategoriaDTO(String nombreCategoria) throws DAOExcepcion{
		try{
			connManager.connect();
			ResultSet rs=connManager.queryDB("select * from CATEGORIA where NOMBRE='"+nombreCategoria+"'");						
			connManager.close();
